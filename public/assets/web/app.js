...
(self.webpackChunk = self.webpackChunk || []).push([[260], {
    946: (e, t, n) => {
        ...
        function i(e) {
            e.needConfirmation ? (o("#giftVIPModal #confirmation-details").html('<span class="font-weight-bold">Username:</span> '.concat(e.username, '<br/> <span class="font-weight-bold">VIP Rank:</span> ').concat(e.productName, '<br/> <span class="font-weight-bold">Price:</span> &pound;').concat(e.price)),
            o("#giftVIPModal #confirmation-section").show()) : (o("#giftVIPModal #gift-vip-form #confirmation-section").hide(),
    ...
    54: (e, t, n) => {
        !function(e) {
            ...
            e.fn.bootstrapAlert = function(t) {
                ...
                if (0 === n.type.length)
                    return console.log("bootstrapAlert: type is empty"),
                    !1;
                if (0 === n.message.length)
                    return console.log("bootstrapAlert: message is empty"),
                    !1;
                ...
                return e(o).append(n.message),
                n.clear && e(this).empty(),
                e(o).appendTo(this),
                this
            }
        }(n(755))
    ...
    981: (e, t, n) => {
        ...
        function P(e, t) {
            ...
            return (o && !n ? t.contains(f) : t === f && "BODY" !== f.nodeName) && (h = b(h, t)),
            h
        }
        function D(e) {
        ...
        function V(e, t, n) {
            ...
            var o = H(e)
              ...
              , f = i ? "height" : "width"
              , l = i ? "width" : "height";
            return r[a] = t[a] + t[f] / 2 - o[f] / 2,
            r[s] = n === s ? t[s] - o[l] : t[B(s)],
            r
        }
        function W(e, t) {
        ...
        function j(e, t, n) {
            return (void 0 === n ? e : e.slice(0, function(e, t, n) {
                ...
                e.enabled && a(n) && (t.offsets.popper = k(t.offsets.popper),
        ...
        function _(e, t, n, o) {
            ...
            var r = l(e);
            return G(r, "scroll", n.updateBound, n.scrollParents),
            n.scrollElement = r,
            n.eventsEnabled = !0,
            n
        }
        ...
        var se = {
                ...
                fn: function(e, t) {
                    ...
                    var l = t.priority
                      ...
                      , c = {
                        primary: function(e) {
                            var n = p[e];
                            return p[e] < f[e] && !t.escapeWithReference && (n = Math.max(p[e], f[e])),
                            M({}, e, n)
                        },
                        secondary: function(e) {
                            var n = "right" === e ? "left" : "top"
                              , o = p[n];
                            return p[e] > f[e] && !t.escapeWithReference && (o = Math.min(p[n], f[e] - ("right" === e ? p.width : p.height))),
                            M({}, n, o)
                        }
                    };
            ...
            keepTogether: {
                ...
                fn: function(e) {
                    var t = e.offsets
                      ...
                      , f = a ? "left" : "top"
                      , l = a ? "width" : "height";
                    return n[s] < i(o[f]) && (e.offsets.popper[f] = i(o[f]) - n[l]),
            ...
            arrow: {
                ...
                fn: function(e, t) {
                    ...
                    e.arrowElement = o,
                    e.offsets.arrow = (M(n = {}, d, Math.round(y)),
                    M(n, u, ""),
                    n),
                    e
                },
            ...
            flip: {
                ...
                fn: function(e, t) {
                    ...
                    return a.forEach((function(s, f) {
                        ...
                        e.placement = o + (i ? "-" + i : ""),
                        e.offsets.popper = T({}, e.offsets.popper, V(e.instance.popper, e.offsets.reference, e.placement)),
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    var a = void 0 !== i ? i : t.gpuAcceleration
                      ...
                      , m = void 0
                      , g = void 0;
                    if (g = "bottom" === c ? "HTML" === s.nodeName ? -s.clientHeight + p.bottom : -f.height + p.bottom : p.top,
                    m = "right" === d ? "HTML" === s.nodeName ? -s.clientWidth + p.right : -f.width + p.right : p.left,
                    a && u)
